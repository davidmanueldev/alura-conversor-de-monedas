...
public class Historial {
    ...
    public void guardar() {
        try (BufferedWriter writer = new BufferedWriter(new FileWriter(ARCHIVO_HISTORIAL))) {
            ...
            System.out.println("El historial ha sido guardado en '" + ARCHIVO_HISTORIAL + "'.");
        } catch (IOException e) {
    ...
    public void cargar() {
        ...
        if (archivo.exists()) {
            ...
            System.out.println("No se encontró un historial previo. Intente nuevamente después de realizar una conversión.");
        }
    }
}
